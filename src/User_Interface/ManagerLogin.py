...
class ManagerLogin:
    ...
    def __init__(self, figure):
        ...
        lb_username.place(x=190, y=110, width=80, height=40)
        ...
        self.edit_username.place(x=270, y=110, width=250, height=40)
        ...
        lb_contact.place(x=190, y=190, width=80, height=40)
        ...
        self.edit_contact["fg"] = "#ffffff"
        self.edit_contact["justify"] = "left"
        self.edit_contact["text"] = ""
        self.edit_contact["show"] = "*"
        self.edit_contact.place(x=270, y=190, width=250, height=40)
